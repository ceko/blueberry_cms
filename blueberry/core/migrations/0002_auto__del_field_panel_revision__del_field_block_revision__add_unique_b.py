...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_panel', 'revision_id')

        # Deleting field 'Block.revision'
        db.delete_column('core_block', 'revision_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Panel.revision'
        raise RuntimeError("Cannot reverse this migration. 'Panel.revision' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Block.revision'
        raise RuntimeError("Cannot reverse this migration. 'Block.revision' and its values cannot be restored.")
