...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Panel.template'
        raise RuntimeError("Cannot reverse this migration. 'Panel.template' and its values cannot be restored.")
